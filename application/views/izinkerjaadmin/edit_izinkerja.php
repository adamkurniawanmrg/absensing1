        ...
        <div class="card-header">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item">
                    <a href="<?=base_url('pegawai/dataizin?token='.$_GET['token']);?>" class="btn btn-sm btn-danger"><em class="ti-arrow-left"></em> Kembali</a>
                </li>
...
<script>
    $(document).ready(function() {
        ...
        function changing() {
            ...
            $.ajax({
                type: "post",
                url: "<?= base_url() . '/pegawai/selectpegawaibyopdeditizin?token=' . $_GET['token']; ?>",
                data: {
                    'opd_id': opd_id,
