        ...
        <div class="card-body">        
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group col-6">
                    <a href="<?= base_url('akseswebsites/konfigurasirole?token=' . $_GET['token']) ?>" class="btn btn-sm btn-danger">Kembali</a>
                    <button type="submit" class="btn btn-sm btn-primary mr-2">Selesai</button>
                </div>
            </form>
        </div>
    </div>
